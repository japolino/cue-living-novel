...
import type { Config, PerspectiveMode, PromptPreset } from "./inlay-config.js";
import {
  CAMERA_ANGLE_VALUES,
  CAMERA_FOCUS_VALUES,
...
function assemblePromptForPerspective(
  ...
  return {
    ...
    ...(perspective.mode === "creative" && creativeConcept !== undefined ? { creativeConcept } : {})
  };
}
